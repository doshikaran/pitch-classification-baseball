...
def get_pitch_name(pitch_type):
    mapping= {"FF" : "4-Seam Fastball",  "CH" :  "Changeup", "CU" : "Curveball", "FC" : "Cutter", "EP" : "Eephus", "FO" : "Forkball", "KC" : "Knuckle Curve", "KN" : "Knuckleball", "FA" : "Other", "PO" : "Pitch Out", "SC" : "Screwball", "SI" : "Sinker", "SL" : "Slider", "CS" : "Slow Curve", "SV" : "Slurve", "FS" : "Split-Finger", "ST" : "Sweeper"}
    return mapping[pitch_type]
